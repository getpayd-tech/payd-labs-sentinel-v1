...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-neutral-950 p-4">
    <div class="text-center max-w-md animate-fade-in-up">
      <div class="w-16 h-16 mx-auto mb-6 rounded-2xl bg-kPrimary/5 dark:bg-neutral-800 flex items-center justify-center">
        <AlertTriangle class="w-8 h-8 text-gray-400" />
      </div>
      <h1 class="text-4xl font-heading font-bold text-kPrimary dark:text-white mb-2">
        404
      </h1>
      ...
      <Button variant="accent" @click="router.push('/')">
        <Home class="w-4 h-4" />
        Back to Dashboard
      </Button>
    </div>
